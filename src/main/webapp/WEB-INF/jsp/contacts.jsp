    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <table class="table table-striped" id="datatable" width = "100%" style = "margin: 0px;">
                <thead>
                <tr>
                    <th><spring:message code="table.n"/></th>
                ...
                <c:forEach items="${contacts}" var="contact">
                    <jsp:useBean id="contact" type="com.github.calve.to.etc.ContactTo"/>
                    <tr>
                        <td>${contact.name}</td>
                        <td>${contact.email}</td>
                        <td><a onclick="updateRow(${contact.id})"><span class="fa fa-pencil"></span></a></td>
                        <td><a onclick="deleteRow(${contact.id})"><span class="fa fa-remove"></span></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
