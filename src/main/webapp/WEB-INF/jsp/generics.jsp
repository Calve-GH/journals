...
<script type="text/javascript" src="resources/js/generics.js" defer></script>
...
<div class="jumbotron pt-4">
    <div class="container-fluid">
        ...
        <div align="center">
            <h5><spring:message code="generics.header.first"/></hr></br>
            <hr><spring:message code="generics.header.second"/></h5>
        </div>
                ...
                <tr>
                    <td>
                        <div class="card-footer text-left">
                            <button class="btn btn-primary" onclick="location.href='template/?type=generics'">
        ...
        <table class="table table-striped table-bordered table-sm" id="datatable" width = "100%" style = "margin: 0px;">
            ...
            <c:forEach items="${mails}" var="mail">
                <jsp:useBean id="mail" type="com.github.calve.to.journal.DefaultTo"/>
