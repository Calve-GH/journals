...
<div class="jumbotron pt-4">
    <div class="container-fluid">
        ...
        <div align="center">
            <h5><spring:message code="applications.header.first"/></hr></br>
            <hr><spring:message code="applications.header.second"/></h5>
        </div>
                ...
                <tr>
                    <td>
                        <div class="card-footer text-left">
                            <button class="btn btn-primary" onclick="location.href='template/?type=applications'">
        ...
        <table class="table table-striped table-bordered table-sm" id="datatable" width = "100%" style = "margin: 0px;">
            <thead>
                <tr>
                    ...
                    <th colspan="3"><spring:message code="table.wrk"/></th>
                    <th rowspan="2"><spring:message code="table.pn"/></th>
                    <th rowspan="2"><spring:message code="table.ex"/></th>
                    <th colspan="2"><spring:message code="table.mod"/></th>
            ...
            <c:forEach items="${mails}" var="mail">
                <jsp:useBean id="mail" type="com.github.calve.to.journal.ApplicationTo"/>
                ...
                <form id="detailsForm">
					...
					<table>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="doneDate" class="col-form-label"><spring:message code="modal.dd"/></label>
									<input type="date" class="form-control" id="doneDate" name="doneDate">
								</div>
							</td>
							<td>
								<div class="form-group">
									<label for="doneIndex" class="col-form-label"><spring:message code="modal.di"/></label>
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<label for="workDate" class="col-form-label"><spring:message code="modal.wd"/></label>
						...
						<tr>
							<td>
								<div class="form-group">
									<label for="workIndex" class="col-form-label"><spring:message code="modal.wi"/></label>
									<input type="text" class="form-control" id="workIndex" name="workIndex">
								</div>
							</td>
							<td>
								<div class="form-group">
									<label for="authority" class="col-form-label"><spring:message code="modal.au"/></label>
