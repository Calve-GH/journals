...
<nav class="navbar navbar-dark bg-dark py-0">
    <div class="container-fluid">
        ...
        <a href="outcome/" class="navbar-brand"><img src="resources/images/outcome48.png"> <spring:message code="app.income"/></a>
        <a href="income/" class="navbar-brand"><img src="resources/images/income48.png"> <spring:message code="app.outcome"/></a>
